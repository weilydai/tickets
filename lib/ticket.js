...
/*
ticket.setPending = function (quantity,callback) {
...
ticket.increasePending = function(quantity) {
  ticket.initList();
...
And then in order, if (ticket.setPending(quantity)) { 
  becomes if (ticket.setPending(quantity,ticket.increasePending
